        ...
        {#if authStore.isAuthenticated}
          ...
          <div class="relative">
            <button
              ...
              class="flex flex-none items-center gap-2 rounded-full hover:bg-muted transition-colors px-2 py-1"
            ...
            {#if showUserDropdown}
              <div class="absolute right-0 top-full mt-2 w-48 bg-card border border-border rounded-xl shadow-lg z-50 overflow-hidden" onblur={() => (showUserDropdown = false)}>
                <button
                  type="button"
                  class="w-full text-left px-4 py-2.5 text-sm text-foreground hover:bg-muted transition-colors"
                ...
                <button
                  type="button"
                  class="w-full text-left px-4 py-2.5 text-sm text-red-500 hover:bg-muted transition-colors"
